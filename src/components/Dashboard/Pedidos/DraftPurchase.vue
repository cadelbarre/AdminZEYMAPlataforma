  ...
  <section>
    ...
    <div class="card">
      ...
      <div class="card-content">
        <b-field
          label="Buscador"
          message="Puede buscar por nombre del cliente, usuario ó por número de pedido."
        >
          <b-input
            ref="draftInput"
            placeholder="Puede buscar por nombre del cliente, usuario ó por número de pedido."
            type="text"
          ></b-input>
        </b-field>
        <b-table
          :data="pendingOrder == null ? [] : pendingOrder"
          striped
          hoverable
          paginated
          per-page="20"
