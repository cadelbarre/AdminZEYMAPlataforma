      ...
      <div class="card-content">
        ...
        >
          <b-table-column
            ...
            width="40"
            sortable
            :subheading="sumDebtFooter == null ? '' : 'Total'"
            v-slot="props"
          >
            {{ props.row.tipo }}
          </b-table-column>
          ...
          <b-table-column
            ...
            width="40"
            numeric
            :subheading="sumDebtFooter == null ? '' : formatNumber(sumDebtFooter.totalNeto)"
            v-slot="props"
          >
          ...
          <b-table-column
            ...
            width="40"
            numeric
            :subheading="sumDebtFooter == null ? '' : formatNumber(sumDebtFooter.totalAbono)"
            v-slot="props"
          >
          ...
          <b-table-column
            ...
            width="40"
            numeric
            :subheading="sumDebtFooter == null ? '' : formatNumber(sumDebtFooter.totalSaldo)"
            v-slot="props"
          >
